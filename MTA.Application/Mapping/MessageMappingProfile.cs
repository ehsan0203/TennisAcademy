...
public class MessageMappingProfile : BaseMappingProfile
{
    public MessageMappingProfile()
    {
        ...
        CreateMap<Message, MessageDto>()
            ...
            .ForMember(dest => dest.SenderImage, opt => opt.MapFrom(src => src.Sender != null ? src.Sender.Image : null))
            .ForMember(dest => dest.MediaFileCount, opt => opt.MapFrom(src => src.MediaFiles != null ? src.MediaFiles.Count : 0))
